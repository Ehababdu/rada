...
<body>
    ...
    <div class="content">
        <div class="section">
            ...
            <div class="info-row">
                ...
                <div class="value">{{ $compensation->martyr->full_name }}</div>
            </div>
            <div class="info-row">
                <div class="label">رقم الهوية الوطنية:</div>
                <div class="value">{{ $compensation->martyr->national_id }}</div>
            </div>
            <div class="info-row">
                <div class="label">الرتبة العسكرية:</div>
                <div class="value">{{ $compensation->martyr->militaryRank?->name_ar ?? 'غير محدد' }}</div>
            </div>
            <div class="info-row">
                <div class="label">حالة الوالدين:</div>
                <div class="value">{{ $compensation->martyr->parentsStatus?->name_ar ?? 'غير محدد' }}</div>
            </div>
            <div class="info-row">
                <div class="label">الحالة الاجتماعية:</div>
                <div class="value">{{ $compensation->martyr->maritalStatus?->name_ar ?? 'غير محدد' }}</div>
            </div>
            <div class="info-row">
                <div class="label">عدد الأطفال:</div>
                <div class="value">{{ $compensation->martyr->children_count ?? 0 }}</div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="info-row">
                ...
                <div class="value">{{ $compensation->recipient_name }}</div>
            </div>
            <div class="info-row">
                <div class="label">رقم جواز السفر:</div>
                <div class="value">{{ $compensation->recipient_passport_number }}</div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="info-row">
                ...
                <div class="value">{{ $compensation->receipt_date->format('d/m/Y') }}</div>
            </div>
            <div class="info-row">
                <div class="label">الأشهر المشمولة:</div>
                <div class="value">
                    @if($compensation->months)
        ...
        <div class="amount">
            المبلغ المستلم: {{ number_format($compensation->amount, 2) }} ريال سعودي
        </div>
    </div>
    ...
    <div class="signature-section">
        ...
        <div class="signature">
            ...
            <p>{{ $compensation->recipient_name }}</p>
        </div>
    </div>

    <div class="footer">
        <p>تم إصدار هذا الإيصال إلكترونياً من نظام إدارة الشهداء والمفقودين</p>
        <p>تاريخ الطباعة: {{ now()->format('d/m/Y H:i:s') }}</p>
    </div>
</body>
</html>