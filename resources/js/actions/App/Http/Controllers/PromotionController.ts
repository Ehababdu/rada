...
/**
* @see \App\Http\Controllers\PromotionController::latestExport
...
const PromotionController = { index, create, store, show, edit, update, destroy, confirm, exportMethod, latestExport, export: exportMethod }
