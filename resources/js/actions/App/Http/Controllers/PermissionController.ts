...
/**
* @see \App\Http\Controllers\PermissionController::apiIndex
* @see app/Http/Controllers/PermissionController.php:101
...
const PermissionController = { index, create, store, show, edit, update, destroy, apiIndex }
