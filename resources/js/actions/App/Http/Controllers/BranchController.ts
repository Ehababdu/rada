...
*/
export const apiIndex = (args: { bank: number | { id: number } } | [bank: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/api/banks/{bank}/branches'
*/
apiIndex.url = (args: { bank: number | { id: number } } | [bank: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
...
* @route '/api/banks/{bank}/branches'
*/
apiIndex.get = (args: { bank: number | { id: number } } | [bank: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: apiIndex.url(args, options),
    method: 'get',
})
...
* @route '/api/banks/{bank}/branches'
*/
apiIndex.head = (args: { bank: number | { id: number } } | [bank: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: apiIndex.url(args, options),
    method: 'head',
})
...
const BranchController = { apiIndex, index, create, store, show, edit, update, destroy }
