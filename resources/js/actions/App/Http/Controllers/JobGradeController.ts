...
/**
* @see \App\Http\Controllers\JobGradeController::apiIndex
* @see app/Http/Controllers/JobGradeController.php:150
...
const JobGradeController = { index, create, store, show, edit, update, destroy, apiIndex }
