...
/**
* @see \App\Http\Controllers\EmployerLocationController::apiIndex
* @see app/Http/Controllers/EmployerLocationController.php:178
* @route '/api/employers/{employer}/locations'
*/
export const apiIndex = (args: { employer: string | number } | [employer: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: apiIndex.url(args, options),
    method: 'get',
})
...
* @route '/api/employers/{employer}/locations'
*/
apiIndex.url = (args: { employer: string | number } | [employer: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return apiIndex.definition.url
...
* @route '/api/employers/{employer}/locations'
*/
apiIndex.get = (args: { employer: string | number } | [employer: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: apiIndex.url(args, options),
    method: 'get',
})
...
* @route '/api/employers/{employer}/locations'
*/
apiIndex.head = (args: { employer: string | number } | [employer: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: apiIndex.url(args, options),
    method: 'head',
})
...
const EmployerLocationController = { apiIndex, index, create, store, show, edit, update, destroy }

export default EmployerLocationController