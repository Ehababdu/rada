...
// Icons
import { ArrowLeft, ArrowRight, MapPin, Loader2, Building2, Save } from 'lucide-react';
...
export default function Create({ bank }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: t('branches.create_branch'), href: `/banks/${bank.id}/branches/create` },
    ];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-6 p-6 max-w-2xl mx-auto w-full" dir={isRTL ? 'rtl' : 'ltr'}>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight">{t('branches.create_branch')}</h1>
                    ...
                    <CardContent className="pt-6">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="name_ar" className="text-sm font-semibold text-foreground">
