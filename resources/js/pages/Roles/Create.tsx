...
export default function Create({ permissions, flash }: Props) {
        ...
        post(rolesStore.url(), {
            onSuccess: () => {
                toast({
                    ...
                    description: t('roles.created_successfully', 'تم إنشاء الدور بنجاح'),
                });
            },
            onError: () => {
                toast({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`${t('roles.create', 'إنشاء دور')} - ${t('roles.title', 'الأدوار')}`} />
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">{t('roles.create', 'إنشاء دور')}</h1>
                        <p className="text-muted-foreground">
                            {t('roles.create_description', 'إنشاء دور جديد وتحديد الصلاحيات المرتبطة به')}
                        </p>
                    </div>
                </div>
