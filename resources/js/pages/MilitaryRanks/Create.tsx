...
export default function Create() {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: t('military_ranks.create'),
            href: '/military-ranks/create',
        },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={t('military_ranks.create_rank')} />
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">
                                {t('military_ranks.create_rank')}
                            </h1>
                            <p className="text-gray-600 dark:text-gray-400 mt-1">
                                {t('military_ranks.add_new_rank')}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="flex justify-end pt-6 border-t border-gray-200 dark:border-gray-700 p-6 rounded-lg">
                        ...
                        >
                            ...
                            {processing ? t('saving') : t('military_ranks.create_rank')}
                        </Button>
                    </div>
                </form>
            </div>
