...
// Icons
import { ChevronLeft, ChevronRight, Columns, Download, FileText, Search, User } from 'lucide-react';
                ...
                <div className="space-y-6 p-6">
                    ...
                    <div className="flex flex-col gap-4 rounded-xl border bg-card p-6 shadow-sm md:flex-row md:items-center md:justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <MartyrsActions canCreate={canCreate} />
                        </div>
                    </div>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    ...
                                                    />
                                                    <Label htmlFor="basic-all">
                                                        {t('martyrs.select_all_basic')}
                                                    </Label>
                                                </div>
                                                {availableColumns
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    ...
                                                    />
                                                    <Label htmlFor="additional-all">
                                                        {t('martyrs.select_all_additional')}
                                                    </Label>
                                                </div>
                                                {availableColumns
                                                    .filter((col) =>
                                                        additionalKeys.includes(col.key),
                                                    )
                                                    .map((col) => (
                                                        <div
                                                            key={col.key}
