...
import { index as employmentStatusesIndex, create as employmentStatusesCreate, store as employmentStatusesStore } from '@/routes/employment-statuses';
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">{t('employment_statuses.create')}</h1>
