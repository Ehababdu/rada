...
import { index as employmentStatusesIndex, create as employmentStatusesCreate, show as employmentStatusesShow, edit as employmentStatusesEdit, destroy as employmentStatusesDestroy } from '@/routes/employment-statuses';
...
export default function Index({ employmentStatuses, filters, flash }: Props) {
    ...
    const handleSearch = () => {
        router.get(employmentStatusesIndex.url(), { search }, {
            preserveState: true,
            replace: true,
        });
    };
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold">{t('employment_statuses.title')}</h1>
                    ...
                    <CardContent>
                        ...
                        <div className="rounded-md border">
                            <Table>
                                <TableHeader>
                                    <TableRow>
                                        <TableHead>{t('employment_statuses.name')}</TableHead>
                                    ...
                                    {employmentStatuses.data.length === 0 ? (
                                        ...
                                        employmentStatuses.data.map((employmentStatus) => (
                                            <TableRow key={employmentStatus.id}>
                                                ...
                                                <TableCell>{employmentStatus.created_at}</TableCell>
                                                <TableCell>
                                                    <div className="flex items-center gap-2">
                                                        <Button variant="ghost" size="sm" asChild>
                                                            <Link href={employmentStatusesShow(employmentStatus.id).url}>
                                                        ...
                                                        <AlertDialog>
                                                            ...
                                                            <AlertDialogContent>
                                                                ...
                                                                <AlertDialogFooter>
                                                                    ...
                                                                    <AlertDialogAction
                                                                        onClick={() => handleDelete(employmentStatus.id)}
                        ...
                        {employmentStatuses.last_page > 1 && (
                            <div className="mt-4 flex justify-center">
                                <div className="flex gap-1">
                                    {employmentStatuses.links.map((link, index) => (
                                        <Button
                                            key={index}
