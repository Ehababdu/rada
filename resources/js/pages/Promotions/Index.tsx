            ...
            <AppLayout breadcrumbs={breadcrumbs}>
                ...
                <div className="space-y-6 p-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                        ...
                        <div className="flex flex-col items-center justify-center rounded-xl border border-red-200 bg-card bg-red-50 p-4 shadow-sm">
                    ...
                    {/* Toolbar */}
                    <div className="flex flex-col items-start justify-between gap-4 px-4 md:flex-row md:items-center md:px-8">
                        {/* Search & Tabs */}
                            ...
                            >
                                ...
                                >
                                    <SheetHeader className="border-b p-6">
                                        ...
                                        <SheetDescription>
                                            قم بتطبيق فلاتر متقدمة للبحث عن
                                            الترقيات
                                        </SheetDescription>
                                    </SheetHeader>
                    ...
                    <div className="flex flex-col gap-4">
                        <div
                            data-slot="card"
                            className="flex flex-col gap-6 rounded-xl border border-muted bg-card py-6 text-card-foreground shadow-sm"
                        >
                                                        ...
                                                        {headerGroup.headers.map(
                                                            (header) => (
                                                                <th
                                                                    ...
                                                                    className="h-10 px-2 text-right align-middle font-bold whitespace-nowrap text-slate-700 [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]"
                                                                >
                        ...
                        {promotions.last_page > 1 && (
                            <div className="flex items-center justify-between pt-2">
                                <span className="text-sm text-muted-foreground">
                                    عرض {promotions.from} إلى {promotions.to} من
                                    أصل {promotions.total}
                                </span>
                                <div className="flex gap-2">
                                    <Button
                                        variant="outline"
                    ...
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                ...
                                <strong>{confirmPromotion?.martyr_name}</strong>{' '}
                                إلى
                                <strong>
                                    {' '}
