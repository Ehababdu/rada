...
import { ArrowLeft, Award, Calendar, User, Edit } from 'lucide-react';
...
export default function Show({ promotion }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`${t('promotions.promotion_details')} - ${promotion.martyr_name}`} />
                ...
                <div className="flex items-center gap-4 bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mt-1">
                            {promotion.martyr_name} - {promotion.martyr_national_id}
                        </p>
                    </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium text-gray-900 dark:text-gray-100">
                                        {promotion.promotion_years} {t('promotions.years')}
                                    </p>
                                </div>
                                <div>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className={`p-6 rounded-lg border shadow-sm ${
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className={`font-semibold ${isOverdue ? 'text-white' : 'text-green-900 dark:text-green-100'}`}>
                                        {isOverdue ? t('promotions.overdue') : t('promotions.upcoming')}
                                    </h3>
                                    <p className={`text-sm ${isOverdue ? 'text-white/90' : 'text-green-700 dark:text-green-300'}`}>
                                        {isOverdue
                                            ? t('promotions.overdue_description')
                                            : t('promotions.upcoming_description')
                                        }
                                    </p>
                                </div>
                            </div>
