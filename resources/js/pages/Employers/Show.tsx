                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                {t('employers.employer_details_view')}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-medium">
                                            {formatDate(employer.updated_at)}
                                        </p>
                                        <div className="mt-0.5 flex items-center gap-1 text-xs text-muted-foreground">
                                            <Clock className="h-3 w-3" />
                        ...
                        <Card className="border-none border-primary/10 bg-primary/5 shadow-sm">
                            ...
                            <CardContent className="flex flex-col gap-2">
                                ...
                                >
                                    <Link
                                        href={`/employers/${employer.id}/edit-location`}
                                    >
                                        <MapPin
                                            className={cn(
                                                'h-4 w-4',
                                        ...
                                        />
                                        {employer.location
                                            ? t('employers.update_location')
                                            : t('employers.add_location')}
                                    </Link>
                                </Button>
                                <Button
                                    variant="outline"
