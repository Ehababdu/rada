...
// Icons
import { ArrowLeft, ArrowRight, Building2, Save, Loader2, Edit3, MapPin } from 'lucide-react';
...
export default function Edit({ employer, locations }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: `${t('edit')}: ${employer.name_ar}`, href: `/employers/${employer.id}/edit` },
    ];
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className={cn(
                                            "bg-background",
                                            isRTL ? "pr-10" : "pl-10",
                                            errors.name_en && "border-destructive focus-visible:ring-destructive"
                                        )}
                                        placeholder={t('employers.enter_name_en')}
                                    />
                                </div>
                                {errors.name_en && (
                                    <p className="text-xs text-destructive font-medium mt-1">{errors.name_en}</p>
                                )}
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Select value={data.employer_location_id} onValueChange={(value) => setData('employer_location_id', value)}>
                                        <SelectTrigger className={cn(isRTL ? "pr-10" : "pl-10", errors.employer_location_id && "border-destructive focus-visible:ring-destructive")}>
                                ...
                                {errors.employer_location_id && (
                                    <p className="text-xs text-destructive font-medium mt-1">{errors.employer_location_id}</p>
                                )}
                            </div>
